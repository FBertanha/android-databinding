...
class NotaData(
    ...
    fun atualiza(nota: Nota) {
        this.nota = nota
        this.titulo.postValue(this.nota.titulo)
        this.descricao.postValue(this.nota.descricao)
        this.favorita.postValue(this.nota.favorita)
        this.imagemUrl.postValue(this.nota.imagemUrl)
    }
